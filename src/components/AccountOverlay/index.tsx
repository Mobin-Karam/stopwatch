...
const AccountOverlay = ({ open, onClose }: AccountOverlayProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-xl space-y-5 overflow-hidden rounded-3xl border border-slate-700 bg-slate-900/95 p-7 shadow-[0_30px_120px_rgba(0,0,0,0.6)] backdrop-blur-lg">
        ...
        {!user ? (
          <div className="relative space-y-4 text-center">
            ...
            <p className="text-slate-300">{t("user.signin")}</p>
          ...
          <div className="relative space-y-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2 className="text-2xl font-semibold text-slate-50">{user.name}</h2>
