...
const LanguageOverlay = ({ open }: LanguageOverlayProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto px-4 py-6 sm:items-center sm:px-6">
      ...
      <div className="relative w-full max-w-lg max-h-[85vh] space-y-4 overflow-y-auto rounded-3xl border border-emerald-400/40 bg-slate-900/90 p-6 text-center shadow-[0_30px_120px_rgba(0,0,0,0.55)] backdrop-blur-lg sm:p-8 tv:max-w-xl tv:p-10">
